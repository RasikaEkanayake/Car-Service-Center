...
namespace Booking
{
    public partial class BK_Main : Form
    {
        ...
        public void Display()
        {
           ...
           /* TSlot1.Text = Convert.ToString(bookingtb.getBookingCountForTime("1", Time));
            TSlot2.Text = Convert.ToString(bookingtb.getBookingCountForTime("2", month));
            TSlot3.Text = Convert.ToString(bookingtb.getBookingCountForTime("3", month));
            TSlot4.Text = Convert.ToString(bookingtb.getBookingCountForTime("4", month));
            TSlot5.Text = Convert.ToString(bookingtb.getBookingCountForTime("5", month));
            TSlot6.Text = Convert.ToString(bookingtb.getBookingCountForTime("6", month));*/
        }
