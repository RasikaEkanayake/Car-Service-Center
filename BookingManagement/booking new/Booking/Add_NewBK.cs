...
namespace Booking
{
    public partial class Add_NewBK : Form
    {
        ...
        public void Clear()
        {
            ...
            txtC_Name.Text = txtContact_No.Text = txtVehicle_No.Text = txtNIC.Text = txtB_Type.Text = txtTime.Text = txtDay.Text = txtMonth.Text = txtService_Slot1.Text = string.Empty;
        }
